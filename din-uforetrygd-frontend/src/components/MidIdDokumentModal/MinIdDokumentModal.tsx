...
export const MinIdDokumentModal: React.FC<MinIdDokumentarkivModalProps> = ({innloggingstype}) => {
    ...
    return (
        <Modal ref={modalRef} onClose={close} aria-label="For lavt innloggingsnivå"
               header={{heading: 'For lavt innloggingsnivå'}}>
            <Modal.Body>
                <VStack gap='6'>
                    <BodyLong>Du er logget inn med MinID. For å komme inn på Dokumenter må du logge inn med et høyere
                        sikkerhetsnivå, for eksempel BankID.
                    </BodyLong>
                    <BodyLong>Du kan se dokumenter knyttet til uføretrygd i saksoversikten her i Din uføretrygd med nåværende innlogging.
                    </BodyLong>
